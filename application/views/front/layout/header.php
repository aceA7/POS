<div class="container">
        ...
        <div class="row">
          <div class="span4">
            <div class="logo">
              <a href="<?=base_url()?>"><img src="<?=base_url()?>/assets/template/front/img/logo.png" alt="" class="logo" /></a>
              <h1>Connecting Programer to People</h1>
            </div>
          </div>
          <div class="span8">
            <div class="navbar navbar-static-top">
              <div class="navigation">
                <nav>
                <?php $this->load->view("front/layout/navigation");?>
                </nav>
              </div>
              <!-- end navigation -->
            </div>
